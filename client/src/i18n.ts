...
const zhHant = {
  ...
  datePicker: {
    ...
    headerYear: '{{year}} 年',
    months: { 1: '1 月', 2: '2 月', 3: '3 月', 4: '4 月', 5: '5 月', 6: '6 月', 7: '7 月', 8: '8 月', 9: '9 月', 10: '10 月', 11: '11 月', 12: '12 月' },
    weekdays: { 0: '日', 1: '一', 2: '二', 3: '三', 4: '四', 5: '五', 6: '六' },
  },
  app: {
    title: '🗂️ OA Agent · 對話式請假單',
    greeting: '你好，我是 OA 請假小幫手。直接用自然語言描述你的請假需求即可 👋',
    user: '使用者',
    statusLabel: '狀態',
    statusInitial: '尚未開始',
    status: { collecting: '蒐集中', confirming: '待確認', submitting: '送出中', submitted: '已送出', cancelled: '已取消', failed: '失敗' },
    reset: '重新開始',
    confirm: '確認',
    cancel: '取消',
    send: '送出',
...
const en = {
  ...
  app: {
    title: '🗂️ OA Agent · Conversational Leave Form',
    greeting: "Hi, I'm the OA leave assistant. Just describe your leave request in your own words 👋",
    user: 'User',
    statusLabel: 'Status',
    statusInitial: 'Not started',
    status: { collecting: 'Collecting', confirming: 'Awaiting confirm', submitting: 'Submitting', submitted: 'Submitted', cancelled: 'Cancelled', failed: 'Failed' },
    reset: 'Restart',
    confirm: 'Confirm',
    cancel: 'Cancel',
    send: 'Send',
    inputPlaceholder: 'Describe your request, e.g. I need annual leave next Mon–Tue for personal reasons',
    ...
    cancelledMsg: 'This form has been cancelled. Click “Restart” to begin a new request.',
  ...
  form: {
    ...
    incomplete: 'Some required fields are incomplete. Please complete them before submitting.',
    next: 'Next',
    previous: 'Previous',
    steps: 'Form steps',
    step: 'Step {{index}}',
