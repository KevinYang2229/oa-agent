...
const renderTime: FieldRenderer = ({ spec, value, disabled, onChange }) => (
  <TimePicker value={value} placeholder={spec.placeholder} disabled={disabled} onChange={onChange} />
);
